...
public class Data {
    ...
    public static Staff[] dataArr() {
        ...
        Staff staff4 = new StaffFullTime(4, "phuong", 21, 9292929, "queyeyw@", 12, 2, 6);
        ...
        Staff staff8 = new StaffFullTime(7, "quyet", 21, 9292929, "queyeyw@", 17, 3, 3);
        Staff staff9 = new StaffFullTime(8, "hieu", 21, 9292929, "queyeyw@", 17, 3, 10);
